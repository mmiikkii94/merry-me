...
<div class="quote typewriter">“You don’t marry the person you can live with … 
    <br>
    You marry the person you can’t live without.”
    <br> —Unknown Author</div>
...
<p>
    ...
    <br>
    <a href="{{ url('/salon') }}"> <i class="far fa-check-square"></i>&nbsp; Salon</a>
    <a href="{{ url('/music') }}"><i class="far fa-check-square"></i>&nbsp;Music</a>
        <a href="{{ url('/catering') }}"><i class="far fa-check-square"></i>&nbsp;Catering</a>
        <a href="{{ url('/clothes') }}"><i class="far fa-check-square"></i>&nbsp;Clothes</a>
        <a href="{{ url('/cakes') }}"><i class="far fa-check-square"></i>&nbsp;Cakes</a>
        <a href="{{ url('/photovideo') }}"><i class="far fa-check-square"></i>&nbsp;Photo and Video</a>
        <a href="{{ url('/jewelry') }}"><i class="far fa-check-square"></i>&nbsp;Jewelry</a>
...
<h2 class="moveRight">How to find a good divorce lawyer?</h2>
