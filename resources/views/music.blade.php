...
<div class="row search-title-margin">
    <div class="col-sm-6 page-title">
           <div class="demotext"> Here  you can find a perfect wedding music band for you: </div></div>
<div class="col-sm-6">
...
<div class="card hover fade-in" style="width: 80%;">
  <img class="card-img-top " src="storage/images/{{$music->images}}" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">
      <div class="left">
      {{$music->name}}
    ...
    <i class="far fa-envelope fa=spin">&nbsp;&nbsp;</i>{{$music->mail}}
    </div>
    <div class="contact-margin">
    <i class="fas fa-phone fa-spin"></i>&nbsp; {{$music->phone}}
    </div>
    <div class="contact-margin">
    <i class="fas fa-link"></i>
    
    <a href="/"> &nbsp;{{$music->website}}</a>
  </div>
  </div>
    <div class="card">
...
<div class="content">
    ...
    <div class="fb-comments" data-href="http://testingsite.com/{{$music->id}}" data-numposts="5"></div>
</div>
</div>
