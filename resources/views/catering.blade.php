...
<div class="row search-title-margin">
    <div class="col-sm-6 page-title">
           <div class="demotext"> Here  you can find a perfect catering company for you: </div></div>
<div class="col-sm-6">
...
<div class="card hover fade-in" style="width: 80%;">
  <img class="card-img-top " src="/images/{{$catering->image}}" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">
      <div class="left">
      {{$catering->name}}
    ...
    <i class="far fa-envelope fa=spin">&nbsp;&nbsp;</i>{{$catering->mail}}
    </div>
    <div class="contact-margin">
    <i class="fas fa-phone fa-spin"></i>&nbsp; {{$catering->phone}}
    </div>
    <div class="contact-margin">
    <i class="fas fa-link"></i>
    
    <a href="/"> &nbsp;{{$catering->website}}</a>
  </div>
  </div>
    <div class="card">
...
<div class="content">
    ...
    <div class="fb-comments" data-href="http://testingsite.com/{{$catering->id}}" data-numposts="5"></div>
</div>
</div>
