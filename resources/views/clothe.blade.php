...
<div class="row search-title-margin">
    <div class="col-sm-6 page-title">
           <div class="demotext">You can find a perfect dress or suit for you: </div></div>
<div class="col-sm-6">
...
<div class="card hover fade-in" style="width: 80%;">
  <img class="card-img-top " src="/images/{{$clothe->image}}" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">
      <div class="left">
      {{$clothe->name}}
    ...
    <i class="far fa-envelope fa=spin">&nbsp;&nbsp;</i>{{$clothe->mail}}
    </div>
    <div class="contact-margin">
    <i class="fas fa-phone fa-spin"></i>&nbsp; {{$clothe->phone}}
    </div>
    <div class="contact-margin">
    <i class="fas fa-link"></i>
    
    <a href="/"> &nbsp;{{$clothe->website}}</a>
  </div>
  </div>
    <div class="card">
...
<div class="content">
    ...
    <div class="fb-comments" data-href="http://testingsite.com/{{$clothe->id}}" data-numposts="5"></div>
</div>
</div>
