...
<div class="row search-title-margin">
    <div class="col-sm-6 page-title">
           <div class="demotext"> Here  you can find a perfect a perfect photo/videographer for you: </div></div>
<div class="col-sm-6">
...
@foreach ($photovideos as $photo)
<div class="col-sm-6">
<div class="card hover fade-in" style="width: 80%;">
  <img class="card-img-top " src="/images/{{$photo->image}}" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">
      <div class="left">
      {{$photo->name}}
    ...
    <i class="far fa-envelope fa=spin">&nbsp;&nbsp;</i>{{$photo->mail}}
    </div>
    <div class="contact-margin">
    <i class="fas fa-phone fa-spin"></i>&nbsp; {{$photo->phone}}
    </div>
    <div class="contact-margin">
    <i class="fas fa-link"></i>
    
    <a href="/"> &nbsp;{{$photo->website}}</a>
  </div>
  </div>
    <div class="card">
...
<div class="content">
    ...
    <div class="fb-comments" data-href="http://testingsite.com/{{$photo->id}}" data-numposts="5"></div>
</div>
</div>
